  ...
  return (
    <Router>
      <div className={
        ...
        <nav className={
          theme === "dark"
            ? "bg-gray-900/90 shadow-md py-4 px-8 flex justify-between items-center sticky top-0 z-10 border-b border-gray-700"
            : "bg-white/90 shadow-md py-4 px-8 flex justify-between items-center sticky top-0 z-10 border-b border-blue-100"
        }>
          <Link to="/" className={
            theme === "dark"
